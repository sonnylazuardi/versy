...
.factory('Fabric', [
    'FabricWindow', '$timeout', '$window', 'FabricCanvas', 'FabricDirtyStatus', '$q', 
    function(FabricWindow, $timeout, $window, FabricCanvas, FabricDirtyStatus, $q) {
    ...
    return function(options) {
        ...
        var self = angular.extend({
            ...
            canvasWidth: 480,
            canvasHeight: 480,
            canvasOriginalHeight: 480,
            canvasOriginalWidth: 480,
        ...
        self.addCustomText = function(str, top, size) {
            str = str || 'New Text';
            var object = new FabricWindow.Text(str, self.textDefaults);
            object.id = self.createId();
        ...
        self.download = function(name) {
            ...
            // Canvas2Image.saveAsImage(canvas, 480, 480, 'jpeg');
